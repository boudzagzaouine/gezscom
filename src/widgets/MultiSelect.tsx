...
export const MultiSelect: FC<MultiSelectProps> = ({
  ...
  ...props
    ...
    const handleChange = useCallback(({currentTarget}: SyntheticEvent<HTMLInputElement>) => {
  ...
  return (
    <div>
      {options.map((option) => {
        return (
          <label key={option.id}>
            <input onChange={handleChange} checked={values.includes(option.id)} type="checkbox" value={option.id} />
