  ...
  return (
    ...
    <div className='grid grid-rows-6'>
                        ...
                        <label  className=" " >Genre</label>
                            <div className="  ">
                                <label  {...register("genre")} >
                                    <input name="genre"  value="h" type="radio" className='mr-1' />
                                    Homme
                                </label>
                            </div>
                            <div className=" ">
                                <label {...register("genre")} >
                                    <input name='genre'  value="f" type="radio"  className='mr-1' />
                                    Femme
                                </label>
                            </div>
                    </div>
                ...
                <div className="flex my-5">
                    ...
                    <div className="">
                        ...
                        <div className="">
                            <div className="my-5">
                                <label >
                                    <input    value="add" type="checkbox" className="mr-5"{...register("lien")} />
                                    Créer un lien de du profile automatiquement 
                                </label>
                            </div>
                            <div className="my-5">
                                <label >
                                    <input  value="auto"  type="checkbox" className="mr-5" {...register("auto")} />
        ...
        <div className='row-span-1'>
            ...
            <button className="h-10 w-52  my-10 rounded-md bg-gray-800 text-white float-left mr-10 " type='submit'  >Sauvgarder et Nouveau</button>
            </div>
            <div className="">
                <button  className="h-10 w-40  my-10 rounded-md bg-gray-800 text-white float-right mr-10 " type='button' onClick={()=> setEstAjt(false)} >Annuler</button>
                <button className="h-10 w-40  my-10 rounded-md bg-gray-800 text-white float-right mr-10 " type='submit'  >Sauvgarder</button>
            </div>
        </div>
    </div>
    </form>
