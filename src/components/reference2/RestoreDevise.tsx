...
import { useRestoreDeviseMutation } from "config/rtk";
...
const RestoreDevise = ({ id }: RestoreDevisePorp, ref: Ref<void>) => {
    const [id0, setId0] = useState(id);
    //@ts-ignore
    const { register, handleSubmit } = useForm<string>({
        defaultValues: { id0 },
    });
    const [restore] = useRestoreDeviseMutation();
...
export default forwardRef(RestoreDevise);
