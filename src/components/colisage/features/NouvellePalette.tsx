            ...
            <div className='m-auto'> 
                <div className="flex my-5 w-full ">
                    <div className="flex items-center ml-5">
                        <Field label="N° Palette"  name="NPalette" type="number"  className="w-96" placeholder="1" />
                    </div>
                    <div className="flex items-center ml-5">
                ...
                <div className="flex my-5">
                    <div className="flex items-center ">
                        <Field label="Nombre de colis"  name="Nombrecolis" type="number"  className="w-96" placeholder="20"/>
                    </div>
                </div>  
            </div>
        </div>
