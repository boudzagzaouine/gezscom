...
function FicheDeColisage({setShowColis,estModifier,setModifier,colis,setColis,ClientJson}:ConsulterUtilisateurProps) {
    ...
    const ColisToOpen:any = openColis(0)
  ...
  return (
    <Section>
            <Form  defaultValues={colis0}  onSubmit={()=>{saveColis(colis);refetchColis();setModifier(false)}} >
            <div className='grid grid-rows-6'>
                <div className='row-span-1'>
                    <p className='float-left text-xl'>Fiche de colisage Ref {colis.id}</p>
                    <XIcon className='w-6 h-6 float-right cursor-pointer' onClick={()=>{setShowColis(false)}} />
                            ...
                            <Table.tr key={p.code}  >
                                ...
                                <Table.td className='cursor-pointer'>
                                    <div className='flex float-right mx-2'>
                                        ...
                                        <AnnulationDesCommandes showAnnulation={showAnnulation} setshowAnnulation={setShowAnnulation}  />
                                        <PlusIcon className='w-7 h-7 border-2 rounded-full border-black text-black mx-2 ' onClick={()=>setshowAffectation(true)}  />
                                        <AffectationDesColis showAffectation={showAffectation} setshowAffectation={setshowAffectation}  />
                                    </div>
                        ...
                        return (
                                ...
                                <Table.td>
                                    <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-semibold sm:pr-6 md:pr-0">
                                     <Button className="text-green-600 hover:text-green-800" onClick={()=>{setShowModalE(true)}}>Modifier</Button>
                                     <ModifPalette  showModalE={showModalE} setShowModalE={setShowModalE}/> 
                                    </td>
                                </Table.td>                                
                            </Table.tr>
                        )
