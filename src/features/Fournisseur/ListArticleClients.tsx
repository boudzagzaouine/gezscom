...
import FormArticleClients from "./FormArticleClients";

const ListArticleClients=({fournisseur}:ListFournisseursProps)=>{
    const [commandes, setCommandes]=useState(fournisseur.commandes);
    const {data=[],refetch}=useFetchCommandesFournisseurByIdFournisseurQuery(fournisseur.id)
