...
import {
  openMatierePremiereByFournisseur,
  OpenMatierePremiereJoinProp,
  OpenMatierePremiereProp,
  openMatierePremieres,
...
const FormulaireLigneDeCommande = ({
  ligneCommande,
  idfournisseur,
  saveArticle,
  close,
  refetch,
}: FormLignedeCommandeProp) => {
  const matierePremiereByFournisseurOpen: OpenMatierePremiereJoinProp =
    openMatierePremiereByFournisseur(idfournisseur);
  const matierePremieres: MatierePremiere[] =
    matierePremiereByFournisseurOpen.data;
