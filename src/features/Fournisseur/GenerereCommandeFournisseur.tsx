...
const GenerereCommandeFournisseur = ()=>{
    const genereCommand :MenuNavTabs[]=[
        {
            id:1,
            name:(<><BriefcaseIcon className={style_icon} aria-hidden="true" /><span className={style_span}>Commandes Clients a Générer</span></>),
            featured: (<ListCommandClientGenerer/>),
        },
        {
            id:2,
              name:(<><ClipboardListIcon className={style_icon} aria-hidden="true" /><span className={style_span}>Commandes Fournisseurs Générée</span></>),
