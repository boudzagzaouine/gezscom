...
const FormPayementMode = () => {
  ...
  return<List body={["Désignation#design#attr","Code#code#attr"]}  list={payementModesToOpen.data.content} emptyObject={payementMode0} save={payementModesToOpen.save} edit={payementModesToOpen.edit} refetch={payementModesToOpen.refetch} />;
};
