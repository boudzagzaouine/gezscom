...
export default function TestCommande() {
  ...
  //@ts-ignore
  const cm1: Commande = {
    id: "43cc3483-1e96-4f00-acce-c2091ba498e3",
    date: "2022-05-14T17:10:19.091+00:00",
    season: "saison 5215",
    amount: 10430.0,
    idClient: "bae9ef60-b3ea-4934-81e8-2c6dd3498fb3",
    adrLiv: "",
  };
  //const { data = [], isFetching, refetch } =  usePaginationCommandesQuery(0);
  const { data = [], refetch } = useFetchcommandesByIdClientQuery(
    "42e8d8ec-ac63-455e-badc-08ec7feb3b3b"
  );
  //@ts-ignore
