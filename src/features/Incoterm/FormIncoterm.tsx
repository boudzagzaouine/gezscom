...
const FormIncoterm = ({
    ...
    const { data = [], isFetching, refetch } = useFetchIncotermsQuery()
        ...
        return ([
            {
                ...
                text: "Détail",
                action: () => { open(incoterm); setRequest(REQUEST_EDIT); setDisabled(true) },
            },
            {
                icon: (
                    <PencilAltIcon
                ...
                text: "Modifier",
                action: () => { open(incoterm); setRequest(REQUEST_EDIT); setDisabled(false) },
            },
            {
                icon: (
                    <TrashIcon
            ...
            {!form && (
                <section className='bg-white float-left w-full h-full mp-8 shadow-lg'>
                    ...
                    <div className='float-left w-full'>
                        <button className='bg-cyan-800 p-3 text-white rounded border border-cyan-900py-2 px-4 border rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 float-left' onClick={() => { open(incoterm0) }}>Nouveau Incoterm</button>
                            ...
                            data.content?.map((incoterm: Incoterm) => {
                                return (
                                    ...
                                    <tr key={incoterm.id}>
                                        ...
                                        <Table.td className='cursor-pointer'><Mitems menu={menu(incoterm)} /></Table.td>
                                    </tr>
                                )
                            })
                        }
