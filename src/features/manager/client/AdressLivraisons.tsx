    ...
    <>
      ...
      >
        {data?.map((adressLiv) => (
          ...
          {selectedIdCommande==adressLiv.id && formArt && <FormAdressLivraisons adressLiv={adressLiv}   close={close} saveAdressLiv={edit} refetch={refetchAll}/>}
          </>
        ))}
        {selectedIdCommande=="new" && formArt && <FormAdressLivraisons adressLiv={adr1}  close={close} saveAdressLiv={save} refetch={refetchAll}/>}
        {!formArt && <tr
          onClick={() => {
            open("new")
          }}
