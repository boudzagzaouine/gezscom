...
const FormCommande = (
  ...
  return (
    <Modal
      ...
      title={
        command0.id == ""
          ? "Novelle commande client"
          : "Commande client :" + client0.design
      }
    >
      ...
      {!disabled0 && (
        <Bcancel
          className={"float-right b-ajust " + (command0.id == "" && "b-ajustf")}
          onClick={() => {
            if (command0.id != "") setDisabled0(true);
            else close();
          }}
        />
      )}
