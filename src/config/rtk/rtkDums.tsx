...
export const crudDum = createApi({
  ...
  endpoints(builder) {
    return {
      ...
      editDum: builder.mutation<Dum, Partial<Dum> & Pick<Dum, "id">>({
        query: (body) => ({
          url: `/dums/${body.id}`,
          method: "PUT",
          body,
      ...
      archiveDum: builder.mutation<Dum, Partial<Dum> & Pick<Dum, "id">>({
        query: (id) => ({
          url: `/dums/${id}/archive`,
          method: "PUT",
        }),
      }),
      restoreDum: builder.mutation<Dum, Partial<Dum> & Pick<Dum, "id">>({
        query: (id) => ({
          url: `/dums/${id}/restore`,
          method: "PUT",
        }),
