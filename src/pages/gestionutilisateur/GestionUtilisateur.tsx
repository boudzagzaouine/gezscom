...
function GestionUtilisateur():JSX.Element {
  ...
  return <>
         { !estAjt && !showUser && <ListUtilisateur setEstAjt={setEstAjt}  setShowUser={setShowUser}   setModifier={setModifier} setUsername={setUsername}/>
        
      }
      { estAjt && !showUser && <NouvelUtilisateur setEstAjt={setEstAjt}   />

      }
      { showUser && !estAjt && <ConsulterUtilisateur setShowUser={setShowUser}  estModifier={estModifier} setModifier={setModifier} username={username} />
